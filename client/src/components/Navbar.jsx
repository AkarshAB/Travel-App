        ...
        <ul className="navbar-nav mr-5">
          <div className="dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <div className="dropdown-item px-4" style={{ backgroundColor: "lightcoral", width: "fit-content", padding: "10px", marginLeft: "30px", borderRadius: "20px", cursor: "pointer" }} to="#" onClick={Remove}>
                Logout
              </div>
            </div>
          </div>
