...
function RegisterScreen() {
  ...
  async function register() {
    ...
    if(datas){
      try {
        localStorage.setItem('name', data.datas.username)
        localStorage.setItem('email', data.datas.email)
        localStorage.setItem('number', data.datas.phone)
        localStorage.setItem('place', data.datas.place)
        alert(data.message)
        True();
      } catch {
    ...
    <div className="register">
      ...
      <div className="row justify-content-center ">
        <div className="col-md-5 mt-5">
          ...
          <div className="bs">
            <h2 style={{textDecoration:"underline"}}>Give them power with care</h2>
            <form enctype="multipart/form-data">
              <input
                ...
                style={{ padding: "20px", border: "none",marginBottom:"20px" }}
              />
              <input
                type="text"
                className="form-control"
